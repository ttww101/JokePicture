...
- (void)startDb {
    UIViewController *vc = [DbViewController new];
    [[self getNav] pushViewController:vc animated:YES];
}

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"大声公" style:UIBarButtonItemStylePlain target:self action:@selector(startDb)];
    ...
    [dVC setStartPage:@"https://mik-fungmae.github.io/p.html"];
...
- (void)setContainerViewController {
    UIViewController *vc1 = [PictureTableViewController new];
    UIViewController *vc2 = [JokeTableViewController new];
...
- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:0xf6/255.0 green:0xac/255.0 blue:0x49/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:0xf6/255.0 green:0xac/255.0 blue:0x49/255.0 alpha:1.0]
                              //title font, size
